...
class Settings:
    def __init__(self) -> None:
        self.database_url_from_env = os.getenv("DATABASE_URL")
        self.database_url = self.database_url_from_env or "sqlite:///./todosapp.db"
        self.is_render = _to_bool(os.getenv("RENDER"), default=False)
